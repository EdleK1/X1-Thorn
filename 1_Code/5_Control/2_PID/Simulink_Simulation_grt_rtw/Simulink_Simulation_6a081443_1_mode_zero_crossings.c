...
const NeZCData *Simulink_Simulation_6a081443_1_ZCData = NULL;
PmfMessageId Simulink_Simulation_6a081443_1_computeAsmModeVector(const double
...
PmfMessageId Simulink_Simulation_6a081443_1_computeSimModeVector(const double
  *input, const double *inputDot, const double *inputDdot, int *modeVector,
  double *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId Simulink_Simulation_6a081443_1_computeZeroCrossings(const
