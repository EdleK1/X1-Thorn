...
file = "timing_advance_7.5_brk_5_5.csv";
...
% Determine plot color based on filename
if contains(file, "timing_advance_7.5")
    plot_color = 'b'; % Blue for 7.5
elseif contains(file, "timing_advance_15")
    plot_color = 'r'; % Red for 15
else
    plot_color = 'k'; % Default to black if neither condition matches
end
...
%% -------------------- Time Plots ----------------------- %%
figure(1)
plot(time, rpm, ".", 'Color', plot_color)
...
figure(2)
plot(time, voltage, ".", 'Color', plot_color)
xlabel("time (s)", "Interpreter", "Latex")
...
figure(3)
plot(time, current, ".", 'Color', plot_color)
xlabel("time (s)", "Interpreter", "Latex")
...
figure(4)
plot(time, temperature, ".", 'Color', plot_color)
xlabel("time (s)", "Interpreter", "Latex")
...
figure(5)
plot(time, power, ".", 'Color', plot_color)
xlabel("time (s)", "Interpreter", "Latex")
...
%% -------------------- RPM vs Power Plot ----------------------- %%
figure(6)
plot(load_2, power, ".", 'Color', plot_color)
