...
for i = 1:length(Kp_vals)
    ...
    [zeros_z, poles_z, zeros_s, poles_s] = root_locus_func(Ts_val, K_G_val, Kr_val, Kp_vals(i), Ki_val, Kd_val, Nd_val, tau_act_val);
...
for i = 1:length(Ki_vals)
    ...
    [zeros_z, poles_z, zeros_s, poles_s] = root_locus_func(Ts_val, K_G_val, Kr_val, Kp_val, Ki_vals(i), Kd_val, Nd_val, tau_act_val);
...
for i = 1:length(Kd_vals)
    ...
    [zeros_z, poles_z, zeros_s, poles_s] = root_locus_func(Ts_val, K_G_val, Kr_val, Kp_val, Ki_val, Kd_vals(i), Nd_val, tau_act_val);
...
for i = 1:length(Nd_vals)
    ...
    [zeros_z, poles_z, zeros_s, poles_s] = root_locus_func(Ts_val, K_G_val, Kr_val, Kp_val, Ki_val, Kd_val, Nd_vals(i), tau_act_val);
...
% --- Parameter sweep ranges
Kq_vals  = [0:0.025:0.2,0.25:0.05:1];
