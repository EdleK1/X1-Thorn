...
subplot(3,1,2)
plot(time, q_rate,'LineWidth',1); hold on
...
subplot(3,1,3)
plot(time, r_rate,'LineWidth',1); hold on
...
% Figure 9: Current Commands
figure('Name','Current','NumberTitle','off');
plot(time, current,'LineWidth',1)
xlabel('Time (s)','Interpreter','latex',"FontSize",16)
ylabel('Current','Interpreter','latex',"FontSize",16)
title('Current','Interpreter','latex',"FontSize",20)
grid on


% Figure 10: Error Codes
figure('Name','Error Codes','NumberTitle','off');
plot(time, errors,'LineWidth',1)
xlabel('Time (s)','Interpreter','latex',"FontSize",16)
...
% Figure 11: Yaw Commands

yaw_commands = omegaL_ref.^2 - omegaR_ref.^2;
