...
public:
    ...
    Servo_Driver_node() : Node("Servo_Driver_node") {
        ...
        RCLCPP_INFO(this->get_logger(), "set_mode_response_servo1 = %d, set_mode_response_servo2 = %d", set_mode_response_servo1, set_mode_response_servo2);
...
private:
    void topic_callback(const std_msgs::msg::Float32MultiArray::SharedPtr msg) {
        ...
        int pwm_value1 = static_cast<int>(1500 + 700 * servo1_value); // a bit of safety factor
        int pwm_value2 = static_cast<int>(1500 + 700 * servo2_value);
