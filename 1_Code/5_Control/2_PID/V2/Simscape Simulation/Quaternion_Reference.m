...
vec_x_World = [0;0;1];
vec_y_World = cross(vec_z_Aircraft,vec_x_World);      %% Aquest es el ordre correcte, sino gira
vec_z_World = cross(vec_x_World,vec_y_World);

% vec_x_World = [0;0;1];
% vec_z_World = cross(vec_x_World,vec_y_Aircraft);    %% Aquest es el que portavem fins el dia 05.10-25
