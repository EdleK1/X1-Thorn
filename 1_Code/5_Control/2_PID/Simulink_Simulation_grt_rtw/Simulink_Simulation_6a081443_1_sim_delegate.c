...
void Simulink_Simulation_6a081443_1_perturbSimJointPrimitiveState(const void
...
void Simulink_Simulation_6a081443_1_perturbFlexibleBodyState(const void *mech,
...
void Simulink_Simulation_6a081443_1_constructStateVector(const void *mech, const
...
void Simulink_Simulation_6a081443_1_extractSolverStateVector(const void *mech,
...
boolean_T Simulink_Simulation_6a081443_1_isPositionViolation(const void *mech,
...
boolean_T Simulink_Simulation_6a081443_1_isVelocityViolation(const void *mech,
  const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
  double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId Simulink_Simulation_6a081443_1_projectStateSim(const void *mech,
...
void Simulink_Simulation_6a081443_1_computeConstraintError(const void *mech,
...
boolean_T Simulink_Simulation_6a081443_1_hasJointDisToNormModeChange(const void *
...
void Simulink_Simulation_6a081443_1_onModeChangedCutJoints(const void *mech,
